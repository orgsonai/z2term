...
**0.8.569-alpha (versionCode 577).** フリーフォーム項目はMotorola端末で縮小表示を既定として要求し、項目設定の「縮小しない」で従来表示も選べます。既存項目も縮小が既定です。0.8.568の通知バッジ修正も含みます。最新の APK と全リリース履歴は **[GitHub Releases](https://github.com/orgsonai/z2term/releases)** にあります。
