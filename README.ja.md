...
**0.8.518-alpha (versionCode 526).** 最新の APK と全リリース履歴は **[GitHub Releases](https://github.com/orgsonai/z2term/releases)** にあります。
...
- **日本語・英語・簡体字中国語・繁体字中国語・スペイン語** — アプリの画面だけでなく **`z2-*` コマンドの表示も言語設定に追従**します（ヘルプ・usage・メッセージまで）。訳の無いところは英語で出ます。⚠ キーボードは別の話で、**中国語の入力方式は内蔵していません** — 中国語を打つときは OS の入力方法に切り替えてください。
