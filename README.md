...
- 0.8.16-alpha 直リンク: [z2term-0.8.16-alpha.apk](https://github.com/orgsonai/z2term/releases/download/v0.8.16-alpha/z2term-0.8.16-alpha.apk)
...
**0.8.16-alpha (versionCode 24) — 長押し選択の信頼性向上 + 一括予測を ◀▶ のブロック境界に追従**
