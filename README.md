...
- 0.8.15-alpha 直リンク: [z2term-0.8.15-alpha.apk](https://github.com/orgsonai/z2term/releases/download/v0.8.15-alpha/z2term-0.8.15-alpha.apk)
...
**0.8.15-alpha (versionCode 23) — 日本語キーボードのフォントを「シンプル / 4 方向フリック」で統一**
