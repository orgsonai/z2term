...
**0.8.214-alpha (versionCode 222).** The latest APKs and the full release history live on **[GitHub Releases](https://github.com/orgsonai/z2term/releases)**.
...
- **Home screen widget** — shows the state (ssh endpoint / resident servers / enabled automation rules / battery) and runs a macro you picked **in the background with one tap, without opening the app**. Each widget gets its own set of macros.
