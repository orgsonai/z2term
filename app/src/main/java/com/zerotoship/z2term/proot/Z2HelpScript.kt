...
|  z2doctor [--share|--clip]      Why isn't it working? Self-check + a report you can paste
        ...
        |  z2-file pick | save FILE     Android document picker / export (z2-file --help)
        ...
        |  z2-torch [on|off|toggle|status]       Flashlight (default toggle)
        |  z2-media [play|pause|next]     Media keys (also previous/stop)
        |  z2-volume up|down|N|N%         Media volume (returns current/max)
        |  z2-audio run COMMAND ...      Run a Linux command with Android audio
...
|  z2doctor [--share|--clip]      動かないときの切り分け診断＋貼れる報告文
    ...
    """,
        ...
        |  z2-file pick | save FILE     Selector y exportación de documentos Android (z2-file --help)
        ...
        |  z2-torch [on|off|toggle|status]       Linterna (toggle por omisión)
        ...
        |  z2-audio run COMMAND ...      Audio de comandos Linux en Android
