...
最終更新: 2026-08-19 / 対象バージョン: 0.8.364-alpha (versionCode 372)
...
- **表示言語は「端末に合わせる / 日本語 / English」の 3 択、既定は端末** (`LocaleHelper`・0.8.363・要望)。
