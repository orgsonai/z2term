...
最終更新: 2026-09-09 / 対象バージョン: 0.8.551-alpha (versionCode 559)
...
バーは1秒長押しで振動してからドラッグでき、離すと左右の近い壁へ吸着して `side` / `offset` を保存します。
ボタンはtap設定なら即ドラッグ、swipe/both設定なら1秒長押し後に移動します。
