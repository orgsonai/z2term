...
最終更新: 2026-09-02 / 対象バージョン: 0.8.488-alpha (versionCode 496)
...
- **音（rdpsnd・0.8.481〜0.8.488）**: 静的仮想チャネル `rdpsnd`（`RdpSound`）で [MS-RDPEA] を話し、相手の音を端末のスピーカーで鳴らす（`RdpAudioSink`）。
