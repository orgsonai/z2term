...
最終更新: 2026-09-09 / 対象バージョン: 0.8.564-alpha (versionCode 572)
...
**板の余白を長押しすると設定を開きます。取っ手は300ms長押し後、動かさず離すと設定、動かすと従来どおり移動です。** 設定の「完了」または戻るで板へ戻ります。
...
バーとボタンは300ms長押しで移動できます。バーの当たり判定は見た目の太さとは別に最低24dpを確保します。
