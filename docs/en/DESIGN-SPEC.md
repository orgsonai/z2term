...
Last updated: 2026-09-02 / Target version: 0.8.488-alpha (versionCode 496)
...
- **Audio (rdpsnd, 0.8.481–0.8.488)**: the `rdpsnd` static virtual channel (`RdpSound`) speaks [MS-RDPEA] and plays the peer's audio through the device speaker (`RdpAudioSink`).
