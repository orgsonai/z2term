...
Last updated: 2026-09-13 / Target version: 0.8.592-alpha (versionCode 600)
...
**Release verification (0.8.592)**: Desktop validation passed: 1,117 unit tests, 2 skipped; signed release APK build, lint and compilation of instrumentation tests. Device audio, synchronization with external actions and notification diagnostics remain incompletely verified.
