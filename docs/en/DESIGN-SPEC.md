...
Last updated: 2026-08-31 / Target version: 0.8.460-alpha (versionCode 468)
...
**What is specific to RDP (0.8.459-0.8.460)**
...
- ⚠ **It still only shows the screen** (`sendPointerEvent` / `sendKeyEvent` are empty). The UI says so — **staying quiet about what does not work reads as "broken"**.
