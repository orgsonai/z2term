...
Last updated: 2026-08-15 / Target version: 0.8.350-alpha (versionCode 358)
...
- ⭐⭐ **The real symptom (no terminal window until you tap) is a missed edge-triggered epoll notification (`EPOLLET`)** (0.8.350, confirmed on-device). Measured with the GUI tab open and untouched:
