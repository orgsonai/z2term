...
Last updated: 2026-09-02 / Target version: 0.8.490-alpha (versionCode 498)
...
- **Audio (rdpsnd, 0.8.481–0.8.490)**: the `rdpsnd` static virtual channel (`RdpSound`) speaks [MS-RDPEA] and plays the peer's audio through the device speaker (`RdpAudioSink`).
